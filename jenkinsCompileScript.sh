...
function mainOfJenkinsCompile() {
    ...
    echo "SetBuildDescription: <a href='$FIR_SHORT_URL' target='_blank'>$FIR_SHORT_URL</a><br/><a href='$PGYER_SHORT_URL' target='_blank'>$PGYER_SHORT_URL</a><br/><a href='$REIKO_SHORT_URL' target='_blank'><img src='$REIKO_QRCODE_URL' alt='在当前页打开apk下载页'/></a><br/>"
    return $result
}
